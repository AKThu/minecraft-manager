        ...
        <div class="mx-auto w-screen max-w-screen-xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-32">
            <div class="mx-auto max-w-prose text-center">
                <h1 class="text-4xl font-bold text-gray-900 sm:text-5xl">
                    ...
                    <strong class="text-rose-500"> Minecraft </strong>
                    worlds
                </h1>

                <p class="mt-4 text-base text-pretty text-gray-700 sm:text-lg/relaxed">
                    Save location for you base, see available resources near your location. See the guides for minecraft gameplay.
                </p>

                <div class="mt-4 flex justify-center gap-4 sm:mt-6">
                    <a class="inline-block rounded border border-rose-500 bg-rose-500 px-5 py-3 font-medium text-white shadow-sm transition-colors hover:bg-rose-700"
                        href="#">
                        Get Started
                    </a>
