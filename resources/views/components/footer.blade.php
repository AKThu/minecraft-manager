<footer class="bg-slate-50 inset-shadow-sm/10 shadow-slate-900">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            <div class="flex justify-center sm:justify-start drop-shadow drop-shadow-slate-300">
            ...
            <p class="mt-4 text-center text-sm text-gray-500 lg:mt-0 lg:text-right drop-shadow drop-shadow-slate-300">
